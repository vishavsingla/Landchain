		...
		<div className=" h-screen ">
			...
			>
				<ul className=" flex flex-col justify-center items-start ">
					<li className=" text-8xl font-bold">Welcome.</li>
					<li className=" font-semibold p-4 text-bold">
						Transforming Land Registry with Blockchain: Secure, Transparent, Immutable
						Ownership Records
					</li>
				</ul>
				<div className="space-x-6 flex flex-row">
					<div className="ml-2 bg-slate-800 p-2 px-12 rounded-3xl font-bold text-md text-slate-100 hover:bg-black hover:text-amber-100">
